...
class OneMessage extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'OneMessage', createEmptyInstance: create)
  ...
  'Will be removed in next major version')
  OneMessage copyWith(void Function(OneMessage) updates) => super.copyWith((message) => updates(message as OneMessage)) as OneMessage; // ignore: deprecated_member_use
